 ...
 * 
 */
public class LegacyConfig extends Properties {

    private static final long serialVersionUID = -4439565094382127683L;

    private static Logger logger = LoggerFactory.getLogger(LegacyConfig.class);

    private static LegacyConfig instance = null;
    ...
    private LegacyConfig() throws IOException, IllegalArgumentException,
