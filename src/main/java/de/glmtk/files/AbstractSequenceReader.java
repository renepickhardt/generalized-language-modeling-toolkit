...
public abstract class AbstractSequenceReader extends AbstractFileReader {
    public static class SequenceComparator<T extends AbstractSequenceReader> implements Comparator<T> {
        @Override
    ...
    public AbstractSequenceReader(Path file,
