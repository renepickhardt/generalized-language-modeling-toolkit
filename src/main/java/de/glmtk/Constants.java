...
public class Constants {
    ...
    /**
     * For glmtk executable
     */
    public static final String WORKING_DIR_SUFFIX = ".glmtk";

    /**
     * For glmtk-expsetup executable
     */
    public static final String EXPSETUP_DIR_SUFFIX = ".expsetup";
    ...
    public static final String TRIES_DIR_NAME = "tries";
