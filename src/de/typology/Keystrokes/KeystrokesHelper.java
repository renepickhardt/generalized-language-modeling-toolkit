...
/**
 * this class contains some helper functions for learning an predicting keystrokes
 * from large amounts of text e.g. Wikipedia
 * 
...
public class KeystrokesHelper {
	 ...
	 * @param nodes
	 */
	public static void OutEdges(HashMap<String, Long> edges, HashMap<String, Long> nodes){
	 ...
	 * @param nodes
	 */
	public static void loadEdges(HashMap<String, Long> edges, HashMap<String, Long> nodes) {
		try {
			File file = new File(Config.get().letterGraph);  
